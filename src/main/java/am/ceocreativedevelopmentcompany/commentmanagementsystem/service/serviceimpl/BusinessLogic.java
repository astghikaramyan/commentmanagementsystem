...
public class BusinessLogic {
    ...
    @AfterReturning(
            pointcut = "execution(* am.ceocreativedevelopmentcompany.commentmanagementsystem.service.CommentService.save(..))",
            returning = "retVal"
    )
    ...
    @AfterReturning(
            pointcut = "execution(* am.ceocreativedevelopmentcompany.commentmanagementsystem.service.NotificationService.save(..))",
            returning = "retVal"
    )
